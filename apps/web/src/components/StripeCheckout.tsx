...
import { isStripeConfigured, initiateStripeCheckout, type CheckoutItem } from '@/lib/stripe';
      ...
      <div className="bg-white rounded-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900">{t('stripe.cardPayment')}</h3>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <h4 className="text-sm font-medium text-gray-700 mb-3">{t('checkout.orderSummary')}</h4>
          ...
          {!stripeConfigured && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
              <p className="text-sm text-yellow-800">{t('stripe.demoMode')}</p>
            </div>
          )}
          ...
          <div className="flex items-center justify-center gap-2 mb-6 text-sm text-gray-500">
            ...
            >
              <path
                d="M59.64 14.28c0-4.44-2.16-7.92-6.24-7.92-4.2 0-6.6 3.48-6.6 7.92 0 5.16 2.88 7.8 7.08 7.8 2.04 0 3.6-.48 4.8-1.2v-3.36c-1.2.6-2.52.96-4.2.96-1.68 0-3.12-.6-3.36-2.64h8.4c0-.24.12-1.08.12-1.56zm-8.52-1.68c0-1.92 1.2-2.76 2.28-2.76 1.08 0 2.16.84 2.16 2.76h-4.44zM40.2 6.48c-1.68 0-2.76.84-3.36 1.44l-.24-1.08h-3.72v19.2l4.2-.84v-4.68c.6.48 1.56 1.08 3.12 1.08 3.12 0 6-2.52 6-8.04-.12-5.04-2.88-7.08-6-7.08zm-1.08 10.92c-1.08 0-1.68-.36-2.16-.84v-6.6c.48-.48 1.2-.84 2.16-.84 1.68 0 2.76 1.8 2.76 4.08.12 2.4-1.08 4.2-2.76 4.2zM26.88 5.52l4.2-.84V1.2l-4.2.84v3.48zM26.88 6.72h4.2v15h-4.2v-15zM22.2 8.16l-.24-1.44H18.6v15h4.2v-10.2c.96-1.32 2.64-1.08 3.24-.84V6.72c-.72-.24-2.64-.72-3.84 1.44zM14.04 2.88l-4.08.84-.12 13.68c0 2.52 1.92 4.44 4.44 4.44 1.44 0 2.4-.24 3-.6v-3.36c-.48.24-3 .96-3-1.56V10.2h3V6.72h-3l.12-3.84h-.36zM4.08 11.04c0-.72.6-1.08 1.56-1.08 1.44 0 3.12.48 4.56 1.2V7.2C8.64 6.6 7.2 6.36 5.64 6.36 2.28 6.36 0 8.28 0 11.28c0 4.68 6.36 3.96 6.36 5.88 0 .84-.72 1.08-1.68 1.08-1.44 0-3.36-.6-4.8-1.44v4.08c1.56.72 3.24 1.08 4.8 1.08 3.48 0 5.88-1.68 5.88-4.8-.12-4.92-6.48-4.2-6.48-6.12z"
                fill="#635BFF"
              />
            </svg>
          </div>
