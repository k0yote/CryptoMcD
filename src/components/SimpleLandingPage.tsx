...
export function SimpleLandingPage() {
  ...
  const handleLoginSuccess = (method: 'wallet' | 'passkey-wallet', username?: string, walletAddress?: string) => {
  ...
  const handlePaymentComplete = (paymentMethod: 'USDC' | 'JPYC' | 'Stripe', network?: 'base' | 'polygon' | 'avalanche' | 'ethereum') => {
