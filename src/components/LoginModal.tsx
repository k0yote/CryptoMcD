...
export function LoginModal({ isOpen, onClose, onSuccess }: LoginModalProps) {
  ...
  const { disconnect: _ } = useDisconnect();
            ...
            {mode === 'select' && (
              <div className="space-y-3">
                ...
                <button
                  onClick={() =>
                    existingWallet
                      ? setMode('passkey-wallet-login')
                      : setMode('passkey-wallet-create')
                  }
                ...
                >
                  <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M3.98877 3.33337L17.7428 13.7307L15.2989 7.56091L3.98877 3.33337Z"
                        fill="#E27625"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M2.53027 27.3258L4.77129 35.0397L12.6773 32.8573L8.98508 27.2023L2.53027 27.3258Z"
                        fill="#E27625"
                      />
                      <path
                        d="M12.2515 17.5765L10.0713 20.8631L17.8757 21.2124L17.6066 12.7765L12.2515 17.5765Z"
                        fill="#E27625"
                      />
                      <path
                        d="M27.7484 17.5765L22.3238 12.6736L22.1207 21.2124L29.9287 20.8631L27.7484 17.5765Z"
                        fill="#E27625"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M22.6009 30.5652L27.3226 32.8574L26.6639 27.3809L22.6009 30.5652Z"
                        fill="#E27625"
                      />
                      <path
                        d="M27.3226 32.8573L22.6009 30.5765L22.9502 33.6579L22.9124 34.9367L27.3226 32.8573Z"
                        fill="#D5BFB2"
                      />
                      <path
                        d="M12.6772 32.8573L17.0874 34.9367L17.0609 33.6579L17.3989 30.5765L12.6772 32.8573Z"
                        fill="#D5BFB2"
                      />
                      <path
                        d="M17.1571 25.5765L13.2299 24.4624L16.0237 23.2336L17.1571 25.5765Z"
                        fill="#233447"
                      />
                      <path
                        d="M22.8428 25.5765L23.9762 23.2336L26.78 24.4624L22.8428 25.5765Z"
                        fill="#233447"
                      />
                      <path
                        d="M12.6773 32.8573L13.3738 27.2023L8.98511 27.3258L12.6773 32.8573Z"
                        fill="#CC6228"
                      />
                      <path
                        d="M26.6261 27.2023L27.3226 32.8573L31.0148 27.3258L26.6261 27.2023Z"
                        fill="#CC6228"
                      />
                      <path
                        d="M29.9287 20.8631L22.1207 21.2124L22.8429 25.5765L23.9763 23.2336L26.7801 24.4624L29.9287 20.8631Z"
                        fill="#CC6228"
                      />
                      <path
                        d="M13.2299 24.4624L16.0237 23.2336L17.1571 25.5765L17.8757 21.2124L10.0713 20.8631L13.2299 24.4624Z"
                        fill="#CC6228"
                      />
                      <path
                        d="M10.0713 20.8631L13.336 27.3809L13.2299 24.4624L10.0713 20.8631Z"
                        fill="#E27525"
                      />
                      <path
                        d="M26.7801 24.4624L26.6639 27.3809L29.9287 20.8631L26.7801 24.4624Z"
                        fill="#E27525"
                      />
                      <path
                        d="M17.8757 21.2124L17.1571 25.5765L18.0514 30.2252L18.2545 23.8631L17.8757 21.2124Z"
                        fill="#E27525"
                      />
                      <path
                        d="M22.1207 21.2124L21.7521 23.8517L21.9486 30.2252L22.8429 25.5765L22.1207 21.2124Z"
                        fill="#E27525"
                      />
                      <path
                        d="M22.8429 25.5765L21.9486 30.2252L22.6009 30.5651L26.6639 27.3809L26.7801 24.4624L22.8429 25.5765Z"
                        fill="#F5841F"
                      />
                      <path
                        d="M13.2299 24.4624L13.336 27.3809L17.399 30.5651L18.0513 30.2252L17.1571 25.5765L13.2299 24.4624Z"
                        fill="#F5841F"
                      />
                      <path
                        d="M22.9125 34.9367L22.9502 33.6579L22.6272 33.3752H17.3727L17.0609 33.6579L17.0874 34.9367L12.6772 32.8573L14.2145 34.1197L17.3237 36.2105H22.6764L25.7856 34.1197L27.3226 32.8573L22.9125 34.9367Z"
                        fill="#C0AC9D"
                      />
                      <path
                        d="M22.6009 30.5651L21.9486 30.2252H18.0513L17.399 30.5651L17.0609 33.6579L17.3727 33.3752H22.6272L22.9502 33.6579L22.6009 30.5651Z"
                        fill="#161616"
                      />
                      <path
                        d="M36.5875 14.3256L37.7994 8.63658L36.0112 3.33337L22.6009 13.2556L27.7484 17.5765L35.0264 19.6973L36.6561 17.7906L35.9496 17.2879L37.0866 16.2559L36.2177 15.5905L37.3547 14.7272L36.5875 14.3256Z"
                        fill="#763E1A"
                      />
                      <path
                        d="M2.20056 8.63658L3.42265 14.3256L2.63533 14.7272L3.77234 15.5905L2.91338 16.2559L4.05039 17.2879L3.34395 17.7906L4.9736 19.6973L12.2515 17.5765L17.399 13.2556L3.98877 3.33337L2.20056 8.63658Z"
                        fill="#763E1A"
                      />
                      <path
                        d="M35.0264 19.6973L27.7484 17.5765L29.9287 20.8631L26.6639 27.3809L31.0149 27.3258H37.4797L35.0264 19.6973Z"
                        fill="#F5841F"
                      />
                      <path
                        d="M12.2515 17.5765L4.9736 19.6973L2.53027 27.3258H8.98508L13.336 27.3809L10.0713 20.8631L12.2515 17.5765Z"
                        fill="#F5841F"
                      />
                      <path
                        d="M22.1207 21.2124L22.6009 13.2556L24.7012 7.56091H15.2989L17.399 13.2556L17.8757 21.2124L18.0415 23.8745L18.0514 30.2252H21.9486L21.9585 23.8745L22.1207 21.2124Z"
                        fill="#F5841F"
                      />
                    </svg>
                  </div>
            ...
            {mode === 'passkey-wallet-create' && (
              <div className="space-y-4">
                <div className="text-center mb-4">
                  ...
                  <p className="text-gray-600 text-sm">{t('login.passkeyWalletDescription')}</p>
                </div>
          ...
          <div className="px-6 pb-6">
            <div className="bg-gray-50 rounded-lg p-3">
              <p className="text-xs text-gray-500 text-center">
                ...
                {(mode === 'passkey-wallet-create' || mode === 'passkey-wallet-login') &&
                  t('login.smartAccountInfo')}
              </p>
            </div>
          </div>
        </div>
